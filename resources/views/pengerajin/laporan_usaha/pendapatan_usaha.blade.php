...
@section('content')
    ...
    @include('pengerajin.laporan_usaha.filter', [
        'action' => route('pengerajin.laporan_usaha.pendapatan-usaha'),
        'resetUrl' => route('pengerajin.laporan_usaha.pendapatan-usaha'),
        'showUsaha' => true,
        'showKategori' => true,
        'showStatus' => true,
        'showDateRange' => true,
        'showPeriode' => true,
        'exportRoute' => 'pengerajin.laporan_usaha.pendapatan-usaha.export',
    ])
    {{-- 📊 RINGKASAN --}}
    <div class="row mb-3">
        <div class="col-md-3">
